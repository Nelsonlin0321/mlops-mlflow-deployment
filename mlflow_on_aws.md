...
# pull ecr
aws ecr get-login-password --region ap-southeast-1 | sudo docker login --username AWS --password-stdin 932682266260.dkr.ecr.ap-southeast-1.amazonaws.com
sudo docker pull 932682266260.dkr.ecr.ap-southeast-1.amazonaws.com/mlflow-postgres-with-s3:latest

sudo docker run -it -p 5050:5050 --env-file docker.env 932682266260.dkr.ecr.ap-southeast-1.amazonaws.com/mlflow-postgres-with-s3:latest
```
...
#!/bin/bash
cd /home/ubuntu
docker run -d -p 5050:5050 --env-file docker.env 932682266260.dkr.ecr.ap-southeast-1.amazonaws.com/mlflow-postgres-with-s3:latest
--//--
```
